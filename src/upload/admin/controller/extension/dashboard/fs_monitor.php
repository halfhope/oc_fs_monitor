...
class ControllerExtensionDashboardFSMonitor extends CompatibleController
{
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/fs_monitor', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/dashboard/fs_monitor', 'user_token=' . $this->session->data['user_token'], true);
	...
	public function dashboard() {
		return $this->compatibleGetChild('extension/module/fs_monitor/widget');
	}
}