...
$_['entry_include_help']     	= 'Each path on a new line. Dirs only.';
$_['entry_include_help_block']  = 'You can use only absolute paths to directories without mask. <br>E.g:<ul><li>/var/www/username/www-data/other_sitename.com/</li></ul>';
$_['entry_exclude']          	= 'Exclude directories and files';
$_['entry_exclude_help']     	= 'Each path on a new line. Files and directories with or without mask.';
$_['entry_exclude_help_block']  = 'You can use asbolude/relative paths with or without mask. <br>E.g.:<ul><li>/var/www/username/www-data/other_sitename.com/</li><li>catalog/view/theme/revolution/stylesheet/ocdbanner-206.css</li><li>assets/dynamic_stylesheet/*.css</li></ul>';
$_['entry_cron_access_key']  	= 'Cron script access key';
