...
class FS_scans {
	...
	public function getScansDiff(array $scans): array {
	...
	private static function getFilesDiff(array $files_old, array $files_new): array {
	...
	public static function getScanSize(array $files): int {
		$scan_size = 0;
