 ...
 */
class ModelSecurityFSMonitor extends Model
{
    ...
    public function deleteScan($scan_id)
    {
        ...
        $this->db->query("DELETE FROM `" . DB_PREFIX . "security_filesystem_monitor` WHERE `scan_id` = " . (int) $scan_id);
    ...
    public function setScanNotification($text)
    {
        ...
        $this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'security_fs', `key` = 'security_fs_notification', `value` = '" . $this->db->escape($text) . "'");
    ...
    public function checkAndInstall($replace = false)
    {
        ...
        if (empty($security_fs_base_path) || $replace) {
            ...
            $this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'security_fs', `key` = 'security_fs_base_path', `value` = '" . $this->db->escape($security_fs_base_path) . "'");
        }
        ...
        if (empty($security_fs_extensions) || $replace) {
            ...
            $this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'security_fs', `key` = 'security_fs_extensions', `value` = '" . $this->db->escape($security_fs_extensions) . "'");
        }
        ...
        if (empty($security_fs_cron_access_key) || $replace) {
            ...
            $this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'security_fs', `key` = 'security_fs_cron_access_key', `value` = '" . $this->db->escape(md5(mt_rand())) . "'");
        }
        ...
        if (is_null($security_fs_cron_save) || $replace) {
            ...
            $this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'security_fs', `key` = 'security_fs_cron_save', `value` = '0'");
        }
        ...
        if (is_null($security_fs_cron_notify) || $replace) {
            ...
            $this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'security_fs', `key` = 'security_fs_cron_notify', `value` = '1'");
        }
